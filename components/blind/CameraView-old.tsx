...
export default function CameraView({ 
  ...
  useEffect(() => {
    if (!autoCapture || !permission?.granted || isProcessing) {
    ...
    const captureFrame = async () => {
      const now = Date.now();
      if (now - lastCaptureRef.current >= captureInterval && !isProcessing) {
  ...
  }, [autoCapture, permission?.granted, isProcessing, captureInterval, takePicture, onSnap]);
