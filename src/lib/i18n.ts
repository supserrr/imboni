...
const resources = {
  en: {
    translation: {
      ...
      wantToVolunteer: "I'd like to volunteer",
      ...
      error: "Error",
      success: "Success",
      noVolunteersAvailable: "No volunteers available at the moment. Please try again later.",
      volunteerDeclined: "Volunteer declined. Finding another volunteer...",
