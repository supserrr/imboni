...
export default function BlindHome() {
  ...
  return (
    <View style={styles.container}>
      <CameraComponent ref={cameraRef} onCapture={(uri) => console.log('Captured:', uri)} colors={colors} dark={dark} />
      ...
      <View style={[styles.overlay, { bottom: insets.bottom + 100 }]}>
        ...
        <View style={styles.buttonContainer}>
          ...
          >
            <Text style={[styles.buttonText, isAnalyzing && styles.analyzingButtonText]}>{isAnalyzing ? "Stop AI" : "Start AI"}</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
